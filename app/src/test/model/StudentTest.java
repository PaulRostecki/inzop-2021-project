...
class StudentTest {
    ...
    private Set<Student> setOne, setTwo, setThree, setFour;
    ...
    void setUp() {
        ...
        studentThree = new Student("Adam", "Nowak", "12345678910", "Slowackiego 20 Poznan", LocalDate.of(1992, 12, 15),
                "555777999", "Adamnowak@gmail.com", "464555");//student with PESEL of s.(1) and rem. values of s.(2)
    ...
    void testHash() {
        ...
        //setThree.forEach(student -> {System.out.println(student.getFirstName());});  //uncomment to check that with failed duplicate add old value did not get overwritten
    }
}