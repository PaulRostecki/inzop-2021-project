...
class LecturerTest {
    private Lecturer lecturerOne, lecturerTwo, lecturerThree;
    private Set<Lecturer> setOne, setTwo, setThree, setFour;
    ...
    void setUp() {
        ...
        lecturerThree = new Lecturer("Adam","Nowak", "12345678910",  "Chrobrego 20 Poznan",  LocalDate.of(1992, 12, 13),
                "555777999",  "adamnowak@gmail.com",  AcademicTitlesEnum.DOCTOR,  "Wtorek 12:00",  25); //lecturer with PESEL of l.(1), and rem. values of l.(2)
    ...
    void testHash() {
        ...
        //setThree.forEach(lecturer -> {System.out.println(lecturer.getFirstName());}); //uncomment to check that with failed duplicate add old value did not get overwritten
    }
}